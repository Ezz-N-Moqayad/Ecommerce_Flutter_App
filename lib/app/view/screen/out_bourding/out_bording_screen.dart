        ...
        child: Column(
          children: [
            ...
            Align(
              ...
              child: TextButton(
                onPressed: (){
                  _pageController.animateToPage(2, duration: Duration(milliseconds: 500), curve: Curves.easeInBack);
                },
                child: Text("SKIP"),
              ),
            ),
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: 15,),
                CustomPageIndecator(selected: _pageSelected == 1,),
                SizedBox(width: 15,),
                CustomPageIndecator(selected: _pageSelected == 2,),
              ],
            ),
            SizedBox(height: 20,),
            Visibility(
